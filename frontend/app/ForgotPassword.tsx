...
const styles = StyleSheet.create({
  container: { flexGrow: 1, padding: 20, alignItems: "center", backgroundColor: "#f0f2f5" },
  card: { width: "100%", maxWidth: 450, backgroundColor: "#fff", borderRadius: 12, padding: 25, marginTop: 40 },
  title: { fontSize: 24, fontWeight: "700", marginBottom: 20, textAlign: "center" },
  input: { backgroundColor: "#f2f2f2", padding: 14, borderRadius: 10, marginBottom: 15, fontSize: 16 },
  error: { color: "#ff4d4d", fontSize: 12, marginBottom: 8 },
  message: { color: "#00ff00", fontSize: 13, marginBottom: 10, textAlign: "center" },
  button: { backgroundColor: "#000", paddingVertical: 16, borderRadius: 10, alignItems: "center" },

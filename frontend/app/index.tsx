...
//              <Pressable style={styles.adminBtn} onPress={() => router.push('/admin/products')}>
...
//             <Text style={styles.adminBtnText}>Manage Products</Text>
//           </Pressable>
//           {/* <Pressable style={styles.adminBtn} onPress={() => router.push('/users')}>
      ...
      >
        <View style={styles.heroOverlay}>
          ...
          <View style={styles.heroButtons}>
            ...
            {/* Admin button – shfaqet vetem per admin */}
            {role === 'admin' && (
              <Pressable style={styles.adminBtn} onPress={() => router.push('/admin/products')}>
                <Text style={styles.adminBtnText}>Manage Products</Text>
              </Pressable>
